...
export const menuReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case DELETE_ITEM_SUCCESS:
            const {updatedMenuList, currentItem} = action.payload;
            return action.payload.isCurrent ? {...state, menuList: updatedMenuList, current: currentItem} : {...state, menuList: updatedMenuList}
